...
public:
    ...
    enemie(int x, int y, bool activeFlag) : x(x), y(y), isActive(false), modes(0) {}
...
public:
    blinky();
    blinky(int x, int y,bool activeFlag);
...
public:
    pinky();
    pinky(int x, int y,bool activeFlag);
...
public:
    inky();
    inky(int x, int y,bool activeFlag);
...
public:
    clyde();
    clyde(int x, int y,bool activeFlag);
